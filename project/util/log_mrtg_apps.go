...
func LogMrtgApps() {
	...
	f := []interface{}{
		logApprovedApplication,
		logRejectedApplication,
	}
	...
	// go logApprovedApplication(b, c)
	// go logRejectedApplication(b, c)
	...
	fmt.Printf("\n** Number of Rejected Applications: %d\n", len(RejectedIdx))

	elapsed := time.Since(start)

	fmt.Printf("\n================================================\n")
	fmt.Printf("= logMrtgApps() - time elapsed: %s", elapsed)
	fmt.Printf("\n================================================\n\n")
}

func logApprovedApplication(b chan bool, c chan<- MrtgType) {
	for _, v := range ApproveIdx {
...
func logRejectedApplication(b chan bool, c chan<- MrtgType) {
